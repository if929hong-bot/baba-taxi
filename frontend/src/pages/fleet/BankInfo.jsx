...
import { Landmark, Copy, CheckCircle, AlertCircle, Building2, User, CreditCard } from 'lucide-react'
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  onClick={handleCopy}
                  className="flex items-center space-x-1 px-3 py-1 bg-gray-100 rounded-lg hover:bg-gray-200"
                >
                  {copied ? (
                    <>
