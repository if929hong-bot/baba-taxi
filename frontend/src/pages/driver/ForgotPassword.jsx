    ...
    >
      {step === 1 && (
        <form onSubmit={handleVerify} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-yellow-600 text-white py-3 rounded-lg font-medium hover:bg-yellow-700 flex items-center justify-center space-x-2"
          >
            {loading ? (
              <>
          ...
          <div className="text-center">
            <Link to={`/fleet/${fleetCode || 'F001'}/driver/login`} className="text-sm text-gray-600 hover:text-yellow-600 flex items-center justify-center space-x-1">
              <ArrowLeft size={16} />
              <span>返回登入</span>
            </Link>
          </div>
      ...
      {step === 3 && (
        <div className="text-center space-y-6">
          ...
          <Link
            to={`/fleet/${fleetCode || 'F001'}/driver/login`}
            className="block w-full bg-yellow-600 text-white py-3 rounded-lg font-medium hover:bg-yellow-700"
          >
            前往登入
          </Link>
        </div>
